...
const Navbar = () => {
  return (
    <>
      ...
      <nav className=" w-[1440px] h-[100px] flex items-center justify-center gap-[150px] font-medium">
        <ul className="flex items-center gap-[70px] text-[16px]">
          <Link href={'/'}><li className="hover:font-normal ">Home</li> </Link>
         <Link href={'/shop'}> <li className="hover:font-normal ">Shop</li> </Link>
          <li className="hover:font-normal ">About</li>
          <li className="hover:font-normal ">Contact</li>
        </ul>
